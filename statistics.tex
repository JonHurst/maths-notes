...
When using the approximation in equation (\ref{eq:16}), the parameters are $n$
and $p$. Assuming that $n$ is specified, we can carry out hypothesis for $p$
using observations of $P_s$ by calculating the critical region using the $p$
